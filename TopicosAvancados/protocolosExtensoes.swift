...
b.adjust()
let bDescription = b.simpleDescrition
...
class RandomNumber: RandomNumberProtocol {
  func random() -> Double {
    return Double.random(in: 1.0...100.0/9)
  }
}
class Dice {
  let sides: Int
...
protocol DigeGameDelegate: AnyObject {
...
printIntegerKinds([3, 19, -27, 0, -6, 0])
